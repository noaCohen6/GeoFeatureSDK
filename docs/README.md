...
├── api-guide.html       # Backend API endpoints & setup
├── android-sdk.html     # SDK integration & methods
├── admin-portal.html    # Portal usage & workflows
├── demo-app.html        # Demo app guide
└── README.md           # This file
```
